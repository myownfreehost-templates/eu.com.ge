...
<link href="data:image/x-icon;base64," rel="icon" type="image/x-icon">
  ...
  <title><?echo $yourdomain;?> - Free Web Hosting with Free Subdomain Name.</title> 
     <meta name="description" content="Free web hosting with 5GB space and short sub-domain <?echo $yourdomain;?>">
...
<form class="form" action="http://cpanel.<?echo $yourdomain;?>/login.php" method="post"> 
      ...
      <div class="links"> <a href="http://cpanel.<?echo $yourdomain;?>/lostpassword.php">Reset Password</a> <a href="http://<?echo $yourdomain;?>/signup.php">Sign Up</a> 
